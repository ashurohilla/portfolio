        ...
        <div className="max-w-6xl mx-auto px-6 py-3">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-1">
               ...
               <Link target='_blank' href="https://algosystem.in/">
                <Button variant="ghost" className="text-slate-600 hover:text-blue-600 hover:bg-blue-50">
                  ...
                  <Link  href="/tooling">
                <Button variant="ghost" className="text-slate-600 hover:text-blue-600 hover:bg-blue-50">
                  <Projector className="w-4 h-4 mr-2" /> Tools
                </Button>
               </Link>
            </div>
          ...
          <div className="lg:col-span-8 space-y-24">
            ...
            <header className="relative">
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                <Link href={"https://drive.google.com/file/d/1hJrewpm3qB1vpM2gwkBus105Fdn6uaF4/view?usp=sharing"} target="_blank" rel="noopener noreferrer">
                 <Button className="rounded-full text-white bg-slate-900 hover:bg-slate-800 px-6">
                   Download Resume
                 </Button>
                </Link>
            ...
            <section>
             ...
             <section>
                ...
                <div className="w-full bg-slate-50 border border-slate-200 rounded-xl p-4 md:p-2 flex items-center justify-center">
                    <InstagramEmbed />
                </div>
